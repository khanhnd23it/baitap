...
public class EchoChatClient {
    ...
    public static void main(String[] args) {
        try (Socket socket = new Socket(SERVER_IP, SERVER_PORT)) { // Connect to server
            ...
            System.out.println("Can't connect to server or interrupted.");
            ie.printStackTrace();
        } finally {
            new Login(); // Always initialize the login screen
        }
    }
}
